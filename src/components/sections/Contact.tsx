              ...
              <div className="bg-surface p-8 rounded-3xl border border-outer/60 shadow-sm h-full flex flex-col justify-between">
                ...
                <div className="border-t border-outer/40 pt-8 mt-8 flex gap-4 justify-start">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 px-4 py-2.5 bg-outer hover:bg-primary hover:text-white rounded-full text-text-secondary transition-all font-pretendard text-sm"
                    aria-label="포트폴리오 소스코드 깃허브 방문 (새 창 이동)"
                  >
                    <Github size={18} />
                    <span className="font-medium">Portfolio Source Code</span>
                  </a>
                </div>
              </div>
            </FadeIn>
